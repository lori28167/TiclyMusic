...
class MusicApp:
    def __init__(self, root):
        self.root = root
        self.root.title("PyMusic App - Play Music")
        ...
        # UI elements
        self.label = tk.Label(self.root, text="PyMusic - Cerca e ascolta la musica", font=("Arial", 16))
        ...
        self.play_button = tk.Button(self.root, text="Scarica e ascolta", command=self.play_music)
        ...
        # Song Info - current time and duration labels
        self.song_info_label = tk.Label(self.root, text="Canzone: 0:00 / 0:00", font=("Arial", 14))
